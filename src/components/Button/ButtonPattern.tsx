...
export function ButtonRoot(
  { variant = "primary", children, disabled = false, twWidth, type = "button", isLoading, onClick, twPaddingX = "px-[19px]", twPaddingY = "py-[7px]" }
    : ButtonRootProps) {
  return (
    <button
      onClick={onClick}
      ...
      className={clsx(
        `rounded-[6px] text-normal ${twPaddingX} ${twPaddingY} border-[2px] focus:outline-none flex items-center justify-center gap-2 ${twWidth}`,
        {
          ...
          "border-main-red-300 text-main-red-300 hover:text-main-red-500 active:text-main-red-500 focus:bg-typo-200 active:bg-main-red-200/30 hover:border-main-red-500": variant === "outlined" && !disabled,
